class PurchaseItem
  ...
  attr_accessor :token, :user_id, :item_id, :postal_code, :prefecture_id, :municipalities, :street_number, :building,
  ...
  def save
    ...
    Address.create(postal_code: postal_code, prefecture_id: prefecture_id, municipalities: municipalities,
                   street_number: street_number, building: building, telephone_number: telephone_number, purchase_id: purchase.id)
  end
end
